...
import locationImg from "@/assets/images/location-5.svg";
...
function InfoBox({ icon, title, description }: IInfoBoxProps) {
  return (
    <div className="p-6 sm:p-8 border border-dashed border-[#D1091E]/25 bg-gradient-to-b from-[#D1091E]/10 to-transparent rounded-xl">
      {icon}
...
export default function HeroSection() {
  ...
  return (
    <section className="relative pt-[70px] bg-[#121118] overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#8B000F] to-transparent"></div>
      ...
      <div className="relative z-10 mx-auto container max-w-[1320px] pt-12 lg:pt-20 px-5 grid xl:grid-cols-[auto_550px] items-center gap-x-28">
        <div className="flex flex-col items-center xl:items-start">
          ...
          <p className="max-w-[580px] text-xs sm:text-base leading-[18px] sm:leading-[24px] tracking-[-0.12px] sm:tracking-[-0.16px] text-center xl:text-left text-white">
            Scrape data at lightning-fast speeds with a Canadian proxy. With
            over 500,000 Residential Canadian IPs at your disposal, efficiency
            is guaranteed.
          </p>
