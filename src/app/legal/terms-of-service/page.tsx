          ...
          <div>
            ...
            <div className="space-y-8">
              ...
              <p className="text-sm sm:text-base tracking-[-0.14px] sm:tracking-[-0.16px] text-primary/80">
                ...
                expressly limited to these Terms of Service. <br />
              ...
              <p className="text-sm sm:text-base tracking-[-0.14px] sm:tracking-[-0.16px] text-primary/80">
                ...
                <br /> This site may contain certain historical information.
              ...
              <p className="text-sm sm:text-base tracking-[-0.14px] sm:tracking-[-0.16px] text-primary/80">
                ...
                In no case shall LightningProxies, our directors, officers,
                ...
                if advised of their possibility. <br />
              ...
              <p className="text-sm sm:text-base tracking-[-0.14px] sm:tracking-[-0.16px] text-primary/80">
                ...
                LightningProxies and our parent, subsidiaries, affiliates,
              ...
              <h4 className="text-base sm:text-xl font-medium tracking-[-0.16px] sm:tracking-[-0.2px]">
                Eligible Services for Refund
              </h4>

              <p className="text-sm sm:text-base tracking-[-0.14px] sm:tracking-[-0.16px] text-primary/80">
                Residential Proxies <br />
                Mobile Proxies <br />
                IPv6 Proxies
              </p>

              <p className="text-sm sm:text-base tracking-[-0.14px] sm:tracking-[-0.16px] text-primary/80">
                Refunds for these services are available under the following
                conditions:
              </p>

              <p className="text-sm sm:text-base tracking-[-0.14px] sm:tracking-[-0.16px] text-primary/80">
                Data Usage: Less than 100MB of data has been used. <br />
                Proof of Unusability: Customer must demonstrate that the service
                is not usable for their specific use case. If the service is
                functioning as intended and meets the described specifications,
                a refund will not be granted, even if less than 100MB of data
                has been used.
              </p>
              ...
              <p className="text-sm sm:text-base tracking-[-0.14px] sm:tracking-[-0.16px] text-primary/80">
                The following services are non-refundable and cannot be
                exchanged for credits: <br />
                Datacenter Proxies <br />
                Unlimited Residential Proxies <br />
                ISP Proxies
              </p>
              ...
              <p className="text-sm sm:text-base tracking-[-0.14px] sm:tracking-[-0.16px] text-primary/80">
                If any of the services listed above experience technical issues
                for more than 48 hours, you may be eligible for a refund under
                the following conditions:
              </p>

              <p className="text-sm sm:text-base tracking-[-0.14px] sm:tracking-[-0.16px] text-primary/80">
                Full Refund: If the issue occurred within the first 48 hours of
                your purchase. <br />
                Partial Refund: If the issue occurred after 48 hours, a partial
                refund may be provided based on the remaining time left on your
                subscription.
              </p>

              <p className="text-sm sm:text-base tracking-[-0.14px] sm:tracking-[-0.16px] text-primary/80">
                Misuse or Abuse: Refunds will not be provided for accounts found
                to be misusing or abusing our services in any way.
              </p>

              <h4 className="text-base sm:text-xl font-medium tracking-[-0.16px] sm:tracking-[-0.2px]">
                No Refunds for Trial Users
              </h4>

              <p className="text-sm sm:text-base tracking-[-0.14px] sm:tracking-[-0.16px] text-primary/80">
                If you received a trial and then purchased the service, a refund
                will not be provided for that purchase under any circumstances,
                even if the service meets the conditions for other refund
                scenarios.
              </p>
