...
export default function ClientsSection() {
  return (
    <section className="-mt-[37.5px] pt-24 border-t border-dark-white bg-gradient-to-b from-off-white to-transparent">
      <div className="mx-auto container max-w-[1320px] flex flex-col items-center">
        <p className="mb-7 text-sm font-semibold tracking-[-0.14px] uppercase text-center">
          Trusted by World's Top Leading Web Scraping Companies
        </p>

        <div className="mb-8 flex flex-wrap justify-center items-center gap-12">
          <Image src={clientImg1} alt="" />
          <span className="w-px h-[15px] bg-primary/25"></span>
          <Image src={clientImg2} alt="" />
          <span className="w-px h-[15px] bg-primary/25"></span>
          <Image src={clientImg3} alt="" />
          <span className="w-px h-[15px] bg-primary/25"></span>
          <Image src={clientImg4} alt="" />
          <span className="w-px h-[15px] bg-primary/25"></span>
          <Image src={clientImg5} alt="" />
          <span className="w-px h-[15px] bg-primary/25"></span>
          <Image src={clientImg6} alt="" />
        </div>

        <p className="mb-6 py-1.5 px-3.5 border border-primary/25 rounded-full flex items-center gap-2.5 text-sm tracking-[-0.14px]">
