...
function UseCaseCard({
  ...
  return (
    <div className="w-full min-w-[468px] py-6 px-8 border border-dark-white bg-off-white rounded-xl">
      <p
        className="mb-4 w-fit py-2 px-3.5 rounded-lg flex items-center gap-2.5 tracking-[-0.16px] font-medium"
        style={{
      ...
      <p className="mb-4 tracking-[-0.16px]">{description}</p>

      <Link
        href={"/"}
        className="mb-6 flex items-center gap-2.5 font-medium tracking-[-0.16px] opacity-80 hover:opacity-100 duration-200"
      >
        Learn More{" "}
        <svg
          width="6"
  ...
  return (
    <section className="pt-44 overflow-hidden">
      <div className="mx-auto container max-w-[1320px]">
        <p className="mb-3 text-sm font-semibold tracking-[-0.14px] uppercase text-center text-green">
          Use Cases
        </p>

        <h2 className="mb-10 text-[42px] font-semibold leading-[46px] tracking-[-0.84px] text-center">
          Discover the most suitable proxy solution <br /> tailored to your
          specific use case
        </h2>
