...
import detailsImg from "@/assets/images/ad-verification-details.svg";
  ...
  return (
    <div>
      <div className="mb-2 flex items-center gap-2 sm:gap-2.5">
        ...
        <h3 className="text-xs sm:text-base font-medium tracking-[-0.16px] text-[#A400DD]">
          {title}
        </h3>
      </div>
      ...
      <div className="mx-auto container max-w-[1320px] px-5">
        <div className="grid lg:grid-cols-2 gap-y-10 gap-x-16 items-center">
          ...
          <div className="order-1 sm:order-2">
            ...
            <button className="active:scale-95 w-full sm:w-fit py-2.5 sm:py-2 px-5 border border-dark-white bg-white rounded-lg flex justify-center items-center gap-2.5 text-xs sm:text-base font-medium tracking-[-0.16px] text-[#A400DD] duration-300">
              View all use cases
              <svg
                width="13"
                height="11"
