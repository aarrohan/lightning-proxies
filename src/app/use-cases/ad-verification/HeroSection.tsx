...
import useCase4BigImg from "@/assets/images/use-case-4-big.png";
...
function InfoBox({ icon, title, description }: IInfoBoxProps) {
  return (
    <div className="p-6 sm:p-8 border border-dashed border-[#A400DD]/25 bg-gradient-to-b from-[#A400DD]/10 to-transparent rounded-xl">
      {icon}
...
export default function HeroSection() {
  ...
  return (
    <section className="relative pt-[70px] bg-[#010502] overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#5D0096] to-transparent"></div>
      ...
      <div className="relative z-10 mx-auto container max-w-[1320px] pt-12 lg:pt-20 px-5 grid xl:grid-cols-2 items-end gap-x-24">
        <div className="flex flex-col items-center xl:items-start">
          ...
          <h1 className="mb-8 sm:mb-6 text-4xl sm:text-[64px] leading-[10px] sm:leading-[72px] tracking-[-1.08px] sm:tracking-[-1.95px] font-semibold text-center xl:text-left text-white">
            ...
            >
              <rect
                ...
                height="66.8036"
                rx="17.4643"
                transform="rotate(-7.6966 0.843689 10.6428)"
                fill="#A400DD"
                fillOpacity="0.25"
              />
              <rect
              ...
              />
              <path
                d="M31.9159 24.3311C32.8711 23.2654 33.3495 22.7314 33.8779 22.3856C34.4809 21.9905 35.1646 21.7353 35.879 21.6387C36.5934 21.5421 37.3203 21.6066 38.0066 21.8274C38.6079 22.0205 39.2109 22.4082 40.4148 23.182C41.6559 23.9791 42.8505 24.3058 44.3528 24.2218C45.7821 24.144 46.4978 24.1059 47.1168 24.2341C48.546 24.5328 49.7649 25.4597 50.4308 26.7604C50.7186 27.3212 50.8719 28.0214 51.1766 29.4219C51.4947 30.8926 52.1247 31.9559 53.2228 32.9407C54.2904 33.8957 54.8243 34.3741 55.1701 34.9025C55.971 36.1243 56.1763 37.6424 55.7283 39.0312C55.5353 39.6325 55.1476 40.2355 54.3738 41.4394C53.5935 42.5975 53.2271 43.9851 53.3339 45.3774C53.4117 46.8067 53.4499 47.5224 53.3216 48.1414C53.1745 48.8473 52.8713 49.5113 52.4341 50.0848C51.997 50.6582 51.4371 51.1265 50.7954 51.4554C50.2345 51.7432 49.5344 51.8965 48.1338 52.2013C46.6632 52.5193 45.5999 53.1493 44.615 54.2474C43.6601 55.315 43.1817 55.8489 42.6532 56.1947C42.0503 56.5899 41.3665 56.8451 40.6521 56.9417C39.9377 57.0383 39.2108 56.9738 38.5245 56.7529C37.9233 56.5599 37.3202 56.1722 36.1163 55.3984C34.9583 54.6181 33.5707 54.2517 32.1784 54.3585C30.749 54.4364 30.0333 54.4745 29.4143 54.3463C28.7084 54.1991 28.0444 53.8959 27.471 53.4587C26.8975 53.0216 26.4292 52.4617 26.1003 51.82C25.8126 51.2591 25.6593 50.559 25.3545 49.1584C25.0881 47.7886 24.3671 46.5487 23.3083 45.6396C22.2407 44.6847 21.7068 44.2063 21.3592 43.6781C20.9643 43.075 20.7094 42.3911 20.6131 41.6767C20.5168 40.9622 20.5817 40.2353 20.8028 39.5492C20.9959 38.9479 21.3836 38.3449 22.1574 37.141C22.9701 35.875 23.279 34.6753 23.1972 33.203C23.1194 31.7737 23.0813 31.0579 23.2095 30.4389C23.3566 29.733 23.6599 29.069 24.097 28.4956C24.5341 27.9222 25.0941 27.4538 25.7357 27.1249C26.2966 26.8372 26.9968 26.6839 28.3973 26.3791C29.7672 26.1127 31.0068 25.3899 31.9159 24.3311Z"
                stroke="#A400DD"
                strokeWidth="3"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M32.2338 41.3044L35.4626 44.124C35.6751 44.3097 35.9268 44.4451 36.1988 44.52C36.4709 44.5948 36.7564 44.6074 37.034 44.5565C37.3116 44.5057 37.5741 44.3929 37.802 44.2265C38.03 44.0601 38.2174 43.8444 38.3503 43.5955L43.7825 33.4367"
                stroke="#A400DD"
                strokeWidth="3"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <p className="max-w-[580px] text-xs sm:text-base leading-[18px] sm:leading-[24px] tracking-[-0.12px] sm:tracking-[-0.16px] text-center xl:text-left text-white">
            Ensure real-time ad monitoring and combat ad fraud with our proxies
            for ad verification. Access geotargeted ads, verify campaigns
            effectively, and maintain ad accuracy with dependable and efficient
            proxy solutions.
          </p>
        ...
        <div className="hidden xl:flex justify-center">
          <Image src={useCase4BigImg} alt="" className="w-full rounded-xl" />
        </div>
      </div>
