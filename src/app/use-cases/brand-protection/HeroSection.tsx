...
import useCase5BigImg from "@/assets/images/use-case-5-big.svg";
...
function InfoBox({ icon, title, description }: IInfoBoxProps) {
  return (
    <div className="p-6 sm:p-8 border border-dashed border-[#D10975]/25 bg-gradient-to-b from-[#D10975]/10 to-transparent rounded-xl">
      {icon}
...
export default function HeroSection() {
  ...
  return (
    <section className="relative pt-[70px] bg-[#010502] overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#680038] to-transparent"></div>
      ...
      <div className="relative z-10 mx-auto container max-w-[1320px] pt-12 lg:pt-20 px-5 grid xl:grid-cols-2 items-end gap-x-24">
        <div className="flex flex-col items-center xl:items-start">
          ...
          <p className="max-w-[580px] text-xs sm:text-base leading-[18px] sm:leading-[24px] tracking-[-0.12px] sm:tracking-[-0.16px] text-center xl:text-left text-white">
            Protect your brand’s reputation with our dedicated brand protection
            proxies. Monitor unauthorized use, prevent counterfeit activity, and
            safeguard your brand’s integrity by accessing online content
        ...
        <div className="hidden xl:flex justify-center">
          <Image src={useCase5BigImg} alt="" className="w-full rounded-xl" />
        </div>
      </div>
