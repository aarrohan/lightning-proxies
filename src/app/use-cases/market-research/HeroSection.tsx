...
import useCase3BigImg from "@/assets/images/use-case-3-big.png";
...
function InfoBox({ icon, title, description }: IInfoBoxProps) {
  return (
    <div className="p-6 sm:p-8 border border-dashed border-[#FC721A]/25 bg-gradient-to-b from-[#FC721A]/10 to-transparent rounded-xl">
      {icon}
...
export default function HeroSection() {
  ...
  return (
    <section className="relative pt-[70px] bg-[#010502] overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#863400] to-transparent"></div>
      ...
      <div className="relative z-10 mx-auto container max-w-[1320px] pt-12 lg:pt-20 px-5 grid xl:grid-cols-2 items-end gap-x-24">
          ...
          <h1 className="mb-8 sm:mb-6 text-4xl sm:text-[64px] leading-[10px] sm:leading-[72px] tracking-[-1.08px] sm:tracking-[-1.95px] font-semibold text-center xl:text-left text-white">
            ...
            >
              ...
              <rect
                ...
                strokeWidth="1.5"
              />
              <g clipPath="url(#clip0_357_63832)">
                <path
                  d="M35.9716 36.2729L38.1895 38.2076C38.3934 38.3862 38.7089 38.3265 38.8358 38.0899L42.0075 32.1609M48.8938 54.8806C49.6329 54.7806 50.3022 54.3911 50.7542 53.7978C51.2062 53.2044 51.404 52.4558 51.3041 51.7166C51.2041 50.9774 50.8146 50.3082 50.2213 49.8561C49.6279 49.4041 48.8793 49.2063 48.1401 49.3063C47.4009 49.4062 46.7317 49.7957 46.2796 50.3891C45.8276 50.9824 45.6298 51.7311 45.7298 52.4703C45.8297 53.2094 46.2192 53.8787 46.8126 54.3307C47.4059 54.7827 48.1546 54.9805 48.8938 54.8806ZM34.029 56.8903C34.7682 56.7904 35.4374 56.4009 35.8894 55.8075C36.3415 55.2142 36.5393 54.4656 36.4393 53.7264C36.3394 52.9872 35.9499 52.318 35.3565 51.8659C34.7631 51.4139 34.0145 51.2161 33.2753 51.3161C32.5361 51.416 31.8669 51.8055 31.4149 52.3989C30.9629 52.9922 30.7651 53.7408 30.865 54.48C30.965 55.2192 31.3545 55.8885 31.9478 56.3405C32.5412 56.7925 33.2898 56.9903 34.029 56.8903Z"
                  stroke="#FC721A"
                  strokeWidth="3"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M21.2054 29.1092L49.4744 25.2871C52.0349 24.9409 54.2027 27.0507 53.8214 29.5203L52.155 40.3411C51.8972 42.0032 50.5335 43.3076 48.8129 43.5403L31.7965 45.841C30.074 46.0739 28.4107 45.1768 27.7229 43.6445L21.2054 29.1092ZM21.2054 29.1092L19.2832 24.8281"
                  stroke="#FC721A"
                  strokeWidth="3"
                  strokeLinecap="round"
                  strokeLinejoin="round"
              ...
              <defs>
                <clipPath id="clip0_357_63832">
                  <rect
                    width="45"
                    height="45"
                    fill="white"
                    transform="translate(12.9551 20.0078) rotate(-7.7)"
                  />
                </clipPath>
              </defs>
            </svg>
        ...
        <div className="hidden xl:flex justify-center">
          <Image src={useCase3BigImg} alt="" className="w-full rounded-xl" />
        </div>
      </div>
