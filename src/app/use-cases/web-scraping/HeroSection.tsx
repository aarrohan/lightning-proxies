...
import useCase2BigImg from "@/assets/images/use-case-2-big.png";
...
function InfoBox({ icon, title, description }: IInfoBoxProps) {
  return (
    <div className="p-6 sm:p-8 border border-dashed border-accent/25 bg-gradient-to-b from-accent/10 to-transparent rounded-xl">
      {icon}
...
export default function HeroSection() {
  ...
  return (
    <section className="relative pt-[70px] bg-[#010502] overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#002F74] to-transparent"></div>
      ...
      <div className="relative z-10 mx-auto container max-w-[1320px] pt-12 lg:pt-20 px-5 grid xl:grid-cols-2 items-end gap-x-28">
        <div className="flex flex-col items-center xl:items-start">
          ...
          <h1 className="mb-8 sm:mb-6 text-4xl sm:text-[64px] leading-[10px] sm:leading-[72px] tracking-[-1.08px] sm:tracking-[-1.95px] font-semibold text-center xl:text-left text-white">
            ...
            >
              ...
              />
              <path
                d="M40.5281 56.0128C42.7242 55.7159 44.8402 54.9893 46.7555 53.8746C48.6708 52.7599 50.3478 51.2788 51.6907 49.516C53.0336 47.7532 54.0161 45.7431 54.5822 43.6006C55.1483 41.4581 55.2868 39.225 54.9899 37.0289C54.693 34.8329 53.9664 32.7168 52.8517 30.8015C51.737 28.8862 50.2559 27.2092 48.4931 25.8663C46.7303 24.5234 44.7202 23.5409 42.5777 22.9748C40.4352 22.4087 38.2021 22.2702 36.006 22.5671M40.5281 56.0128C38.332 56.3097 36.0989 56.1712 33.9564 55.6051C31.8139 55.039 29.8038 54.0565 28.041 52.7136C26.2782 51.3707 24.7971 49.6937 23.6824 47.7784C22.5677 45.8631 21.8411 43.747 21.5442 41.551C21.2473 39.3549 21.3858 37.1218 21.9519 34.9793C22.518 32.8368 23.5005 30.8267 24.8434 29.0639C26.1864 27.3011 27.8633 25.82 29.7786 24.7053C31.6939 23.5906 33.81 22.864 36.006 22.5671M40.5281 56.0128C45.6583 55.3192 46.5538 45.4294 45.5898 38.2999C44.6259 31.1704 41.1362 21.8735 36.006 22.5671M40.5281 56.0128C35.3979 56.7064 31.9083 47.4095 30.9443 40.28C29.9804 33.1505 30.8758 23.2607 36.006 22.5671M21.7196 35.8511L53.3072 31.5803M23.2269 46.9996L54.8145 42.7288"
                stroke="#1675FF"
                strokeWidth="3"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <p className="max-w-[580px] text-xs sm:text-base leading-[18px] sm:leading-[24px] tracking-[-0.12px] sm:tracking-[-0.16px] text-center xl:text-left text-white">
            Empower your data scraping and market research with
            LightningProxies. Our high-speed proxies are perfect for large-scale
            web scraping and data collection, delivering scalability and
        ...
        <div className="hidden xl:flex justify-center">
          <Image src={useCase2BigImg} alt="" className="w-full rounded-xl" />
        </div>
      </div>
