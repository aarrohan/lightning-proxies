...
import useCase1BigImg from "@/assets/images/use-case-1-big.png";
...
function InfoBox({ icon, title, description }: IInfoBoxProps) {
  return (
    <div className="p-6 sm:p-8 border border-dashed border-[#16D857]/25 bg-gradient-to-b from-[#16D857]/10 to-transparent rounded-xl">
      {icon}
...
export default function HeroSection() {
  ...
  return (
    <section className="relative pt-[70px] bg-[#010502] overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#034C23] to-transparent"></div>
      ...
      <div className="relative z-10 mx-auto container max-w-[1320px] pt-12 lg:pt-20 px-5 grid xl:grid-cols-2 items-end gap-x-28">
        <div className="flex flex-col items-center xl:items-start">
          ...
          <h1 className="mb-8 sm:mb-6 text-4xl sm:text-[64px] leading-[10px] sm:leading-[72px] tracking-[-1.08px] sm:tracking-[-1.95px] font-semibold text-center xl:text-left text-white">
            ...
            >
              <rect
                ...
                height="66.8036"
                rx="17.4643"
                transform="rotate(-7.6966 1.57806 10.5041)"
                fill="#12A250"
                fillOpacity="0.25"
              />
              <rect
              ...
              />
              <path
                d="M27.1035 35.0848C28.5819 34.885 29.9204 34.1061 30.8245 32.9194C31.7286 31.7327 32.1243 30.2355 31.9245 28.7571C31.7247 27.2787 30.9457 25.9402 29.7591 25.0361C28.5724 24.132 27.0752 23.7363 25.5968 23.9361C24.1184 24.1359 22.7799 24.9148 21.8758 26.1015C20.9717 27.2882 20.576 28.7854 20.7758 30.2638C20.9756 31.7422 21.7545 33.0807 22.9412 33.9848C24.1278 34.8889 25.6251 35.2846 27.1035 35.0848ZM27.1035 35.0848L30.1168 57.3821M50.9075 43.22C52.3859 43.0202 53.8831 43.4159 55.0697 44.32C56.2564 45.2241 57.0353 46.5626 57.2351 48.041C57.4349 49.5194 57.0392 51.0167 56.1351 52.2033C55.231 53.39 53.8925 54.1689 52.4141 54.3687C50.9357 54.5685 49.4385 54.1728 48.2518 53.2687C47.0652 52.3646 46.2863 51.0261 46.0865 49.5477C45.8867 48.0693 46.2823 46.5721 47.1865 45.3854C48.0906 44.1988 49.4291 43.4198 50.9075 43.22ZM50.9075 43.22L49.0241 29.2842C48.8909 28.2986 48.3716 27.4063 47.5805 26.8036C46.7894 26.2008 45.7913 25.937 44.8057 26.0702L40.1604 26.698"
                stroke="#12A250"
                strokeWidth="3"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <path
                d="M42.646 31.0915L37.3729 27.074L41.3904 21.8009"
                stroke="#12A250"
                strokeWidth="3"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <p className="max-w-[580px] text-xs sm:text-base leading-[18px] sm:leading-[24px] tracking-[-0.12px] sm:tracking-[-0.16px] text-center xl:text-left text-white">
            Get accurate search engine data using our scraping solutions and SEO
            proxy servers. Utilize public SERP data effectively to monitor
            rankings and enhance your brand's online visibility.
          </p>
        ...
        <div className="hidden xl:flex justify-center">
          <Image src={useCase1BigImg} alt="" className="w-full rounded-xl" />
        </div>
      </div>
