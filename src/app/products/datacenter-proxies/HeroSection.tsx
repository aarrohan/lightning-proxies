...
import productBigImg from "@/assets/images/product-2-big.svg";
import PricingPart from "@/app/pricing/datacenter-proxies/PricingPart";
...
export default function HeroSection() {
  return (
    <section className="relative pt-[70px] bg-[#010502] overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-[45%] sm:h-[80%] bg-gradient-to-b from-[#00C153] via-[#030704] to-transparent"></div>
      ...
      <div className="relative z-10 mx-auto container max-w-[1320px] pt-12 lg:pt-16 pb-12 lg:pb-20 px-5">
        <div className="mb-12 lg:mb-16 w-full h-px bg-[#00C153]"></div>
        <div
          className="absolute top-12 lg:top-16 left-0 w-full h-[170px] opacity-25"
          style={{
            background: `radial-gradient(50.46% 100% at 50% 0%, #00C153 0%, rgba(0, 193, 83, 0.00) 100%)`,
          }}
        ></div>
