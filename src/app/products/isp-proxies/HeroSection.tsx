...
import productBigImg from "@/assets/images/product-3-big.png";
import PricingPart from "@/app/pricing/isp-proxies/PricingPart";
...
export default function HeroSection() {
  return (
    <section className="relative pt-[70px] bg-[#010502] overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-[45%] sm:h-[100%] bg-gradient-to-b from-[#FF792E] via-[#20170A] to-transparent"></div>
      ...
      <div className="relative z-10 mx-auto container max-w-[1320px] pt-12 lg:pt-20 px-5 grid xl:grid-cols-[auto_550px] items-center gap-x-24">
        <div className="flex flex-col items-center xl:items-start">
          ...
          <p className="max-w-[580px] text-xs sm:text-base leading-[18px] sm:leading-[24px] tracking-[-0.12px] sm:tracking-[-0.16px] text-center xl:text-left text-white">
            Static residential ISP proxies engineered for high-traffic web
            scraping operations.
          </p>
      ...
      <div className="relative z-10 mx-auto container max-w-[1320px] pt-12 lg:pt-16 pb-12 lg:pb-20 px-5">
        <div className="mb-12 lg:mb-16 w-full h-px bg-[#FF792E]"></div>
        <div
          className="absolute top-12 lg:top-16 left-0 w-full h-[170px] opacity-25"
          style={{
            background: `radial-gradient(50.46% 100% at 50% 0%, #FF792E 0%, rgba(255, 121, 46, 0.00) 100%)`,
          }}
        ></div>

        <div className="relative z-20 flex flex-col items-center">
          <p className="mb-3 text-[11px] sm:text-sm font-semibold tracking-[-0.11px] sm:tracking-[-0.14px] uppercase text-center text-[#FF4720]">
            PRICING
          </p>
          ...
          <p className="mb-12 text-xs sm:text-base leading-[18px] sm:leading-[24px] tracking-[-0.12px] sm:tracking-[-0.16px] text-center text-white/75">
            <span className="font-semibold">Top success rates</span> and speed
            for cost-effective high-volume scraping.
          </p>
