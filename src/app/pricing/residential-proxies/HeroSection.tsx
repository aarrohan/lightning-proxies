...
import ProductIconImg from "@/assets/images/pricing-product-1-icon.svg";
...
export default function HeroSection() {
  ...
  return (
    <section className="relative pt-[70px] bg-[#121118] overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-[920px] bg-gradient-to-b from-[#0050C3] to-transparent"></div>
