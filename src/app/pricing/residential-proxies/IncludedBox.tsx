...
function InfoBox({ index, totalBoxes, icon, title, subTitle }: IInfoBoxProps) {
  return (
    ...
    >
      <div className="w-[34px] sm:w-[44px] aspect-square border border-accent/25 bg-accent/10 rounded-full flex justify-center items-center">
        {icon}
      </div>
...
export default function IncludedBox() {
  const infos: IInfoBoxProps[] = [
    ...
    },
    {
      ...
      title: "Country, State, City and ISP",
      subTitle: "Targeting",
    },
    {
      icon: (
