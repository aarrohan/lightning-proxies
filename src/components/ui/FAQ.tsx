...
export default function FAQ({ question, answer }: IProps) {
  const [isActive, setIsActive] = useState<boolean>(false);
  const contentRef = useRef<HTMLDivElement>(null);

  return (
    <div className="py-4 sm:py-6 px-5 sm:px-8 border border-dark-white bg-off-white rounded-lg">
      <div
      ...
      >
        ...
        <button>
          ...
          >
            <path d="M8 0L8 16M16 8L0 8" stroke="#1675FF" strokeWidth="1.5" />
          </svg>
        </button>
      </div>
