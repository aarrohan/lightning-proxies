  ...
  const resourcesLinks: ILinkCard[] = [
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M6.48482 14.759C5.56783 15.2855 3.16357 16.3606 4.62793 17.7058C5.34326 18.363 6.13995 18.833 7.14158 18.833H12.8571C13.8588 18.833 14.6554 18.363 15.3708 17.7058C16.8351 16.3606 14.4308 15.2855 13.5138 14.759C11.3636 13.5243 8.6351 13.5243 6.48482 14.759Z"
            stroke="#1D2026"
            strokeWidth="1.1875"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M12.9173 8.83366C12.9173 10.4445 11.6115 11.7503 10.0007 11.7503C8.38982 11.7503 7.08398 10.4445 7.08398 8.83366C7.08398 7.22283 8.38982 5.91699 10.0007 5.91699C11.6115 5.91699 12.9173 7.22283 12.9173 8.83366Z"
            stroke="#1D2026"
            strokeWidth="1.1875"
          />
          <path
            d="M2.37768 13.8337C1.92019 12.8057 1.66602 11.6678 1.66602 10.4708C1.66602 5.88473 5.39697 2.16699 9.99935 2.16699C14.6017 2.16699 18.3327 5.88473 18.3327 10.4708C18.3327 11.6678 18.0785 12.8057 17.621 13.8337"
            stroke="#1D2026"
            strokeWidth="1.1875"
            strokeLinecap="round"
          />
